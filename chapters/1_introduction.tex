...
These issues led to the development of a number of video streaming technologies, among which \textbf{Adaptive Bitrate Streaming} protocols based on HTTP, nowadays considered the de facto standard in the industry.\cite{bitmovin}
