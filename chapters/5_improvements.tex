...
Note that the source image resolution might not correspond to the one of the \texttt{canvas}, therefore we must specify the destination dimensions when calling the \texttt{drawImage} function.
