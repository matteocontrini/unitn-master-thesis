...
\begin{itemize}
    ...
    \begin{itemize}
        \item The characters before the dot define the name of the codec, as specified by the WebCodecs Codec Registry. For example, in \texttt{avc1.64001f} the string \texttt{avc1} refers to AVC/H.264.\cite{webcodecs_registry}
